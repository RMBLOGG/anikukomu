...
fun LoginScreen(
    ...
    Column(
        ...
        Text(
            text = "Masuk, Weeb! 🌸",
            style = AnikuTypography.displayLarge.copy(fontSize = 32.sp, fontWeight = FontWeight.Bold),
            color = AnikuPink,
        ...
        Text(
            text = "Masuk untuk like, komen, dan follow sesama weeb di AnikuKomu!",
        ...
        OutlinedTextField(
            ...
            label = { Text("Password", color = AnikuTextSecondary) },
            singleLine = true,
        ...
        OutlinedButton(
            ...
            Text(
                ...
                style = AnikuTypography.labelLarge.copy(fontSize = 14.sp),
                color = AnikuPink
            )
        }
